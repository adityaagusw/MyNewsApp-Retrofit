...
import kotlinx.android.synthetic.main.activity_otomotif.*
...
class OtomotifActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Inisialisasi Widget
        recyclerView = findViewById<View>(R.id.rvListBeritaOtomotif) as RecyclerView?
        // RecyclerView harus pakai Layout manager
        recyclerView!!.layoutManager = LinearLayoutManager(this)
        // Eksekusi method

        tampilBeritaOtomotif()
    }

    private fun tampilBeritaOtomotif() {
        val api = InitRetrofit.instance
        // Siapkan request
        val beritaCall = api.beritaotomotif()
        // Kirim request
            ...
            override fun onResponse(call: Call<ResponseBerita>, response: Response<ResponseBerita>) {
                ...
                if (response.isSuccessful) {
                    ...
                    if (status) {
                        ...
                        val adapter = AdapterBerita(this@OtomotifActivity, data_berita!!)
                        recyclerView!!.adapter = adapter
                    } else {
                        // kalau tidak true
                        Toast.makeText(this@OtomotifActivity, "Tidak ada berita untuk saat ini", Toast.LENGTH_SHORT).show()
                    }
                }
            }
